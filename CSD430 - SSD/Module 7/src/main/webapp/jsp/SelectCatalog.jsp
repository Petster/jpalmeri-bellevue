...
<%
  ...
  %>
          ...
          <a href="<%=base%>?action=bookDetails&bookId=<%=pId%>">
            <td><a href="<%=base%>?action=bookDetails&bookId=<%=pId%>"><%=book.getTitle()%></a></td>
            <td><%=book.getAuthor()%></td>
            <td><%=book.getPrice()%></td>
            <td><a href="<%=base%>?action=bookDetails&bookId=<%=pId%>">Details</a></td>
          </a>
          </tr>
