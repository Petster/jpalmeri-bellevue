...
INSERT INTO reservations (id, userID, roomType, reserveDate, fromDate, toDate, price) values (1, 1, 1, '2022-11-07', '2022-12-01', '2022-12-08', 2099.93);

INSERT INTO reservations (id, userID, roomType, reserveDate, fromDate, toDate, price) values (2, 2, 2, '2022-10-07', '2022-11-01', '2022-11-08', 3499.93);

INSERT INTO reservations (id, userID, roomType, reserveDate, fromDate, toDate, price) values (3, 3, 3, '2022-11-07', '2023-01-01', '2023-01-08', 2799.93);
...
INSERT INTO emails (userID, dateSent, reservationNum, userEmail, userFirstName, subject, message) values (2, '2022-12-07', 2, 'john@test.com', 'John', 'Test', 'Test');
