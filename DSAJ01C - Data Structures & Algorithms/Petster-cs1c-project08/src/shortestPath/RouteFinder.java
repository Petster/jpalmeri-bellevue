...
public class RouteFinder
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        final String startingCity = "Phoenix";
        final String [] destinations = {"Philadelphia", "Baltimore"};
		final ArrayList<String> citiesToAvoid = new ArrayList(Arrays.asList(new String[]{"Denver", "Chicago A", "Kansas City", "Dallas", "Cincinnati"}));
//		final String startingCity = "A";
//		final String [] destinations = {"B", "C", "D", "E", "F", "G"};
//		final ArrayList<String> citiesToAvoid = new ArrayList<>();
